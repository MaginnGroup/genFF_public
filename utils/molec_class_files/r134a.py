...
class R134aConstants:
    ...
    def lit_param_set(self):
        ...
        lit_param_set = {
            "sigma_C1":3.745147778484348,  #3F
            "sigma_C2": 3.754395219500661, #1F
            "sigma_F1":2.9817731619451933,
            "sigma_F2":2.606847950246527,
            "sigma_H1":2.2373062685352583,
            "epsilon_C1":20.72900866634978, #3F
            "epsilon_C2":72.61894548387387, #1F
    ...
    def gaff_param_set(self):
        ...
        gaff_param_set = {
            ...
            "sigma_F2":3.118,
            "sigma_H1":2.47,
            "epsilon_C1":55.052, #3F
            "epsilon_C2":55.052, #1F
            "epsilon_F1":30.696,
            "epsilon_F2":30.696,
            "epsilon_H1":7.901,
        }
