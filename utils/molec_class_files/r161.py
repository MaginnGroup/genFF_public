...
class R161Constants:
    """Experimental data and other constants for r161"""
    def __init__(self):
        assert (
    ...
    def expt_Pvap(self):
        ...
        expt_Pvap = {
            220: (46.617 * u.kPa).to_value(u.bar),
            240: (123.44 * u.kPa).to_value(u.bar),
            260: (276.18 * u.kPa).to_value(u.bar),
            280: (543.97 * u.kPa).to_value(u.bar),
            300: (971.55 * u.kPa).to_value(u.bar),
        }
