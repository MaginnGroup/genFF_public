...
class AT_Scheme_01(Atom_Types):
    ...
    def __init__(self):
        #Get Bounds
        at_param_bounds_l = [2, 1.5, 2, 10, 2, 15] #Units of Angstroms and Kelvin for Sigmas and Epsilons
        at_param_bounds_u = [4, 3, 4, 75, 15, 50]
        at_bounds = np.array([at_param_bounds_l, at_param_bounds_u]).T
        self.scheme_name = "at_01"
        #Get Names
        at_keys = ["sigma_C", "sigma_H", "sigma_F", "epsilon_C", "epsilon_H", "epsilon_F"]
        ...
        r14_map_dict = {"sigma_C1": "sigma_C",
                        "sigma_F1": "sigma_F",
                        "epsilon_C1": "epsilon_C",
                        "epsilon_F1": "epsilon_F"}

        r32_map_dict = {"sigma_C": "sigma_C",
                        "sigma_H": "sigma_H",
                        "sigma_F": "sigma_F",
                        "epsilon_C": "epsilon_C",
                        "epsilon_H": "epsilon_H",
        ...
        r50_map_dict = {"sigma_C1": "sigma_C",
                        "sigma_H1": "sigma_H",
                        "epsilon_C1": "epsilon_C",
                        "epsilon_H1": "epsilon_H"}

        r125_map_dict = {"sigma_C1":"sigma_C",
                    "sigma_C2": "sigma_C",
                    "sigma_H1": "sigma_H",
                    "sigma_F1":"sigma_F",
                    "sigma_F2": "sigma_F",
        ...
        r170_map_dict = {"sigma_C1": "sigma_C",
                        "sigma_H1": "sigma_H",
                        "epsilon_C1": "epsilon_C",
                        "epsilon_H1": "epsilon_H"}

        #Test molecules
        r41_map_dict = {"sigma_C1": "sigma_C",
                        "sigma_H1": "sigma_H",
                        "sigma_F1": "sigma_F",
                        "epsilon_C1": "epsilon_C",
                        "epsilon_H1": "epsilon_H",
        ...
        r161_map_dict = {"sigma_C1": "sigma_C",
                         "sigma_C2": "sigma_C",
                        "sigma_H1": "sigma_H",
                        "sigma_H2": "sigma_H",
                        "sigma_F1": "sigma_F",
        ...
        r152_map_dict = {"sigma_C1": "sigma_C",
                        "sigma_H1": "sigma_H",
                        "sigma_F1": "sigma_F",
                        "epsilon_C1": "epsilon_C",
                        "epsilon_H1": "epsilon_H",
        ...
        r116_map_dict = {"sigma_C1": "sigma_C",
                        "sigma_F1": "sigma_F",
                        "epsilon_C1": "epsilon_C",
                        "epsilon_F1": "epsilon_F"}
...
class AT_Scheme_02(Atom_Types):
    ...
    def __init__(self):
        #Get Bounds
        at_param_bounds_l = [2, 1.5, 1.5, 1.5, 1.5, 2, 10, 2, 2, 2, 2, 15] #Units of Angstroms and Kelvin for Sigmas and Epsilons
        at_param_bounds_u = [4, 3,   3,   3,   3,   4, 75, 15,15,15,15, 50]
        at_bounds = np.array([at_param_bounds_l, at_param_bounds_u]).T
        self.scheme_name = "at_02"
        #Get Names
        at_keys = ["sigma_C", "sigma_Hc", "sigma_H1", "sigma_H2", "sigma_H3", "sigma_F", 
                   "epsilon_C", "epsilon_Hc", "epsilon_H1", "epsilon_H2","epsilon_H3", "epsilon_F"]
        assert len(at_keys) == len(at_param_bounds_l) == len(at_param_bounds_u), "Length of at_keys, at_param_bounds_l, and at_param_bounds_u must be the same"
        # Get weight information
        # at_weights = np.zeros(len(at_keys))
        # gaff_params = np.array(at_param_bounds_l) #set initial gaff parameters as lower bounds
