...
problem_setup = opt_atom_types.Problem_Setup(
    molec_data_dict, all_gp_dict, at_class, obj_choice
)
pareto_info = problem_setup.gen_pareto_sets(
    samples, at_class.at_bounds_nm_kjmol, save_data=save_data
)
