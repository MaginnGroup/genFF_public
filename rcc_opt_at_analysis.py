...
for i in range(unique_best_sets.shape[0]):
    ...
    ranked_indices, n_data = visual.rank_parameters(best_real, save_data, x_label_set)

    #Get RCC Analysis
    opt_num_param, rcc, loss_data, opt_params =visual.estimate_opt(best_real, ranked_indices, 
