...
train_molec_data = {"R14":r14_class, 
                   "R32":r32_class, 
                   "R50":r50_class, 
                   "R170":r170_class, 
                   "R125":r125_class, 
...
for molec in list(name_ref.keys()):
    ...
    property_names = ["sim_liq_density", "sim_Pvap", "sim_Hvap"]
    ...
    for property_name in property_names:
        ...
        vle_models[property_name] = run_gpflow_scipy(
            x_train,
            y_train,
            gpflow.kernels.RBF(lengthscales=np.ones(molec_class.n_params + 1)),
        )
    ...
    vle_models[property_name] = run_gpflow_scipy(
        x_train,
        y_train,
        gpflow.kernels.Matern52(lengthscales=np.ones(molec_class.n_params + 1)),
    )
